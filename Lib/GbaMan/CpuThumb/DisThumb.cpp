...
thumbMnemonics[] = {
    ...
    { 0xFE00, 0x1C00, "ADD \t%r0, %r3, #%I{6,m7,0}" },
    { 0xFE00, 0x1E00, "SUB \t%r0, %r3, #%I{6,m7,0}" },

    //  Format 03 : 即値の演算。    //
    { 0xF800, 0x2000, "MOV \t%r8, #%I{0,m255,0}" },
    { 0xF800, 0x2800, "CMP \t%r8, #%I{0,m255,0}" },
    { 0xF800, 0x3000, "ADD \t%r8, #%I{0,m255,0}" },
    { 0xF800, 0x3800, "SUB \t%r8, #%I{0,m255,0}" },
    ...
    { 0xF800, 0x4800, "LDR \t%r8, [PC, #%I{0,m255,2}]\t; %P{0,m255,2}" },
    ...
    //  Format 09 : ロードストア命令。  //
    { 0xF800, 0x6000, "STR \t%r0, [%r3, #%I{6,m31,2}]" },
    { 0xF800, 0x6800, "LDR \t%r0, [%r3, #%I{6,m31,2}]" },
    { 0xF800, 0x7000, "STRB\t%r0, [%r3, #%I{6,m31,0}]" },
    { 0xF800, 0x7800, "LDRB\t%r0, [%r3, #%I{6,m31,0}]" },

    //  Format 10: ロードストア命令（ハーフワード）。   //
    { 0xF800, 0x8000, "STRH\t%r0, [%r3, #%I{6,m31,1}]" },
    { 0xF800, 0x8800, "LDRH\t%r0, [%r3, #%I{6,m31,1}]" },

    //  Format 11 : ロードストア命令（SP-Relative）。   //
    { 0xF800, 0x9000, "STR \t%r8, [SP, #%I{0,m255,2}]" },
    { 0xF800, 0x9800, "LDR \r%r8, [SP, #%I{0,m255,2}]" },

    //  Format 12 : アドレッシング。    //
    { 0xF800, 0xA000, "ADD \t%r8, PC, #%I{0,m255,2}\t(=%p{0,m255,2})" },
    { 0xF800, 0xA800, "ADD \t%r8, SP, #%I{0,m255,2}" },

    //  Format 13 : SP操作。    //
    { 0xFF80, 0xB000, "ADD \tSP, #%I{0,m127,2}" },
    { 0xFF80, 0xB080, "ADD \tSP, #-%I{0,m127,2}" },
